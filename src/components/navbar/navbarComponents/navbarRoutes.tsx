  ...
  return (
    <>
      ...
      <div className=" flex justify-center flex-wrap items-center max-sm:hidden ">
        <Link
          to={"/"}
          className={`md:mx-3 mx-2 sm:text-sm text-xs uppercase font-medium text-slate-300 hover:text-white  min-h-[25px] py-3`}
        >
        ...
        <Link
          to={"#"}
          className={`navbar__desktop__categories md:mx-3 mx-2 sm:text-sm text-xs  uppercase font-medium text-slate-300 hover:text-white py-4 min-h-[25px] delay-100`}
        >
